...
class FleepApi(FleepApiBase):
    ...
    def contact_describe(self, contact_id, contact_name):
        """Set contact name
        """
    ...
    def conversation_create(self, topic = None, emails = None, attachments = None):
    ...
    def conversation_poke(self, conversation_id, email, message_nr, from_message_nr = None):
        """Send poke event
        """
    ...
    def message_delete(self, conversation_id, message_nr, attachment_key = None, from_message_nr = None):
    ...
    def message_pin(self, conversation_id, message_nr, below_pin_message_nr = None, from_message_nr = None):
        """Pin the message.
        """
        return self._webapi_call('api/message/pin', conversation_id,
                message_nr = message_nr,
                below_pin_message_nr = below_pin_message_nr,
                from_message_nr = from_message_nr)

    def message_repin(self, conversation_id, pin_message_nr, below_pin_message_nr = None, from_message_nr = None):
    ...
    def search(self, keywords):
        """Run search.
        """
        return self._webapi_call('api/search', keywords = keywords)
